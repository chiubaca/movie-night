...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    // reference of tv card element for interact.js
    ...
    /**
     * Helper to quickly set the translated postion of tv card works in tandem with transformString
     */
     ...
     */
    function handleCardPlacement(interaction: string): void {
